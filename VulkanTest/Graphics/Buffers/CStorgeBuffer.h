...
static Uint ComputeDynamicStorgeAligment(CVulkanDevice* device_, Uint size_)
{
...
class CStorgeBuffer : public CLocalBuffer
{
	...
	public:
		CStorgeBuffer(CVulkanDevice* device_, Uint elements_count_, Pointer initional_data_ = nullptr, CGpuUploadTask* upload_task_ = nullptr)
