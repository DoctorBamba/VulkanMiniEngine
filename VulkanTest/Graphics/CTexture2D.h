...
{
	friend std::vector<CTexture2D*> TexturesFromBackBuffers(VulkanDevice* device_, VkSwapchainKHR swap_chain_, Uint16 buffers_width_, Uint16 buffer_height_, VkFormat buffers_format_);
	...
	public:
		...
		Void CreateBuffer(Bool attachment_usage_, Pointer construct_data_ = nullptr, CGpuUploadTask* upload_task_ = nullptr) override;
